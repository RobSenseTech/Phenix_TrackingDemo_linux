...
const AP_Param::GroupInfo AP_SerialManager::var_info[] = {
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO("1_PROTOCOL",  1, AP_SerialManager, state[1].protocol, SerialProtocol_Lidar),//zing_modi SerialProtocol_MAVLink
    ...
    // @User: Standard
    AP_GROUPINFO("1_BAUD", 2, AP_SerialManager, state[1].baud, 115),//zing_modi  AP_SERIALMANAGER_MAVLINK_BAUD/1000
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO("2_PROTOCOL",  3, AP_SerialManager, state[2].protocol, SerialProtocol_Lidar),//zing_modi SerialProtocol_MAVLink
    ...
    // @Values: 1:1200,2:2400,4:4800,9:9600,19:19200,38:38400,57:57600,111:111100,115:115200,500:500000,921:921600,1500:1500000
    // @User: Standard
    AP_GROUPINFO("2_BAUD", 4, AP_SerialManager, state[2].baud, 115),//AP_SERIALMANAGER_MAVLINK_BAUD/1000
